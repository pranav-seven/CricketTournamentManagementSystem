...
public class Match {
    ...
    {
        String homescore = (home!=null?home:"TBD")+" "+(homeScore>=0?(homeScore+"-"+homeWickets):"N/A")+(homeOvers==null?"":" ("+homeOvers+")");
        String awayscore = (away!=null?away:"TBD")+" "+(awayScore>=0?(awayScore+"-"+awayWickets):"N/A")+(awayOvers==null?"":" ("+awayOvers+")");
        return homescore+"\n"+awayscore+"\n"+result;
    }
